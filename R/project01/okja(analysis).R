...
#        따라서 평일과 주말에 따른 평점의 차이는 없다고 판단됩니다.
...
#        p-value 값이 유의수준 0.05보다 적게 나와 영가설을 기각하고 대안가설을 채택합니다.
#        따라서 요일에 따른 평점의 차이는 적어도 하나 이상은 있는것으로 판단됩니다.
...
#        p-value 값이 유의수준 0.05보다 적게 나와 영가설을 기각하고 대안가설을 채택합니다.
#        따라서 요금에 따라 평점의 차이가 적어도 하나 이상은 있다고 판단됩니다.
...
#        p-value 값이 유의수준 0.05보다 적게 나와 영가설을 기각하고 대안가설을 채택합니다.
#        따라서 시간대에 따라 평점의 차이가 적어도 하나 이상 있다고 판단됩니다.
